...
import Manage_staff from "../../../components/admin/Manage_staff";
import Block_staff from "../../../components/Modal/Staff_block";
import Update_staff from "../../../components/admin/Update_staff";
import Loading from "../../../components/Modal/Loading";
import userInstance from "../../../axios_interceptor/userAxios";
import Button from "../../../components/reuseble/ButtonComponent";

const Listall_staff = ({ admin }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const result = await userInstance.get(`/admin/staff`);
  ...
  const filteredStaffData = Array.isArray(staffData)
  ...
  return (
    <>
      {Open ? (
        <Manage_staff admin={admin} setOpen={SetOpen} />
      ) : (
                      ...
                      filteredStaffData.map((item) => (
                        ...
                        >
                          <div className="grid grid-cols-2 flex-col md:flex-row gap-2 items-center justify-between">
                            <img
                              src={
                                item?.profileImg || "default-profile-img.png"
                              }
