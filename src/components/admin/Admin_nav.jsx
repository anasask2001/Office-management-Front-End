...
import Listall_staff from "../../pages/admin/managestaff/Listall_staff";
import {Menu, MenuButton, MenuItem, MenuItems } from '@headlessui/react'
import Profile from "../Modal/Profile";
import Manage_interns from "./Manage_interns";
import { getIdfromToken } from "../../services/authService";
import userInstance from "../../axios_interceptor/userAxios";
import Manage_rooms from "../../pages/admin/manageroom/Manage_rooms";
import Manage_fees from "../../pages/admin/managefees/Manage_fees";
import Manage_seat from "../../pages/admin/manageseat/Manage_seat";
import Listall_intern from "../../pages/admin/manageintern/Listall_intern";
    ...
    <>
      ...
      <div className="min-h-screen flex bg-[#DADFEF]">
        <header className="md:flex fixed hidden w-[100%] h-[80px] z-10 bg-[#FFFDFD] shadow-sm p-1 justify-between items-center">
          <dciv className="flex gap-10 justify-center items-center">
          ...
          <div className="flex items-center space-x-2 mr-10">
            ...
            <Menu as="div" className="relative ml-3">
              ...
              <IoIosNotifications title="Notifications"
        ...
        <div className="flex mt-[80px] w-full">
          ...
          {url==="dashboard"?<Admin_dashboard/>:url==="managestaff"?<Listall_staff admin={admin}/>:url==="manageintern"?<Listall_intern admin={admin} />:url==="managerooms"?<Manage_rooms/>:url==="managefees"?<Manage_fees/>:url==="seats"?<Manage_seat/>:<></>}
