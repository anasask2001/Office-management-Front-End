            ...
            <div className="px-6 py-8">
              ...
              <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2 flex justify-end gap-4 mt-4">
                  <button
                    type="submit"
                    className="inline-flex justify-center rounded-md px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-gray-400"
                  >
                    Update
                  </button>
                  ...
                  <ButtonComponent
                    ...
                    children="Cancel"
                    onClick={onClose}
                    className="inline-flex justify-center rounded-md px-4 py-2 text-sm font-medium text-black bg-gray-300 hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400"
                  />
                </div>
              </form>
            </div>
